...
public class MainConfigManager {
    ...
    private String freezeStaff, freezeAlready, unfreezeAlready, altsUse, altsProtectedMessage, frezzeUse;
    ...
    public void loadConfig() {
        ...
        prefix = config.getString("general.prefix", "&#8727F5&lMaxStaff &8» ");
        ...
        altsProtectedMessage = lang.getString("messages.alts-protected",
                "&cYou cannot view the alts of &e{target}&c because they are protected.");
    ...
    public String getAltsProtectedMessage() {
        return altsProtectedMessage;
    }
