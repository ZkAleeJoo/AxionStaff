...
public interface IPunishmentManager {
    ...
    void kickPlayerSilent(CommandSender staff, String targetName, String reason);
    void banPlayer(CommandSender staff, String targetName, String reason, String durationStr);
    void banPlayerSilent(CommandSender staff, String targetName, String reason, String durationStr);
    ...
    void mutePlayerSilent(CommandSender staff, String targetName, String reason, String durationStr);
    ...
    void banIPPlayerSilent(CommandSender staff, String target, String reason, String durationStr);
